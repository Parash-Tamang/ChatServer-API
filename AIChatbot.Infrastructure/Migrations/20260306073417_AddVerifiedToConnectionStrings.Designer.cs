...
namespace AIChatbot.Infrastructure.Migrations
{
    ...
    [Migration("20260306073417_AddVerifiedToConnectionStrings")]
    partial class AddVerifiedToConnectionStrings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AIChatbot.Domain.Entities.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("PromptFunction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AIChatbot.Domain.Entities.ApplicationUser", null)
                        .WithMany()
